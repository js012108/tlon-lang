...
import sys
sys.path.append('../..')
from mas.environment.communication.socket_methods import *
from mas.environment.natural_laws.constants import *
from mas.environment.cultural_laws.control_space import *
from mas.environment.cultural_laws.games.games import *
from mas.environment.resources.resources import *
